...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => ['nullable', 'string', 'email', 'max:255', 'unique:users,email,' . $user->id], // Changed to nullable
            'phone' => ['nullable', 'string', 'max:20', 'regex:/^(?:\+94|0)[1-9][0-9]{8}$/'], // Sri Lankan phone numbers
