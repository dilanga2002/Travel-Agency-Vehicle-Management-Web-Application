                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(route('vehicles.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Vehicles</a>
                                </div>
                            </li>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white shadow rounded-xl p-6">
                            ...
                            <form action="<?php echo e(route('bookings.store')); ?>" method="POST">
                                ...
                                <input type="hidden" name="vehicle_id" value="<?php echo e(request()->get('vehicle_id')); ?>">
                                <input type="hidden" name="price_per_km" value="<?php echo e(request()->get('price_per_km')); ?>">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="date" name="start_date" id="start_date" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>"
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pickup_time')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pickup_location')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dropoff_location')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('destination')); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($driver->id); ?>" <?php echo e(old('driver_id') == $driver->id ? 'selected' : ''); ?> data-available="true"><?php echo e($driver->name); ?> (<?php echo e($driver->license_number); ?>)</option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('total_KiloMeter')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                                  placeholder="Any special requirements or notes..."><?php echo e(old('special_requests')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-white shadow rounded-xl p-6 sticky top-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium" id="summary-rate">Rs. <?php echo e(number_format(request()->get('price_per_km', 0), 2)); ?></span>
                                </div>
                                <div class="flex justify-between">
    ...
    <script>
        async function updateDriverAvailability() {
            ...
            try {
                const response = await fetch('<?php echo e(route('bookings.check-driver-availability')); ?>', {
                    method: 'POST',
                    headers: {
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/bookings/create.blade.php ENDPATH**/ ?>