...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-4 text-gray-600 text-sm">
            <p>Remembered your password? <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold relative after:content-[''] after:absolute after:bottom-[-2px] after:left-0 after:w-full after:h-0.5 after:bg-blue-600 after:scale-x-0 after:origin-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-left">Sign in</a></p>
        </div>
    </form>
</div>
</body>
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>