...
<head>
    ...
    <title>SriTravel - Admin Edit Vehicle</title>
    ...
    <style>
        ...
        .file-upload-preview {
            max-width: 100%;
            max-height: 192px; /* Matches h-48 from create.blade.php */
            margin-top: 10px;
            display: none;
            object-fit: cover;
        ...
        .form-section {
            max-height: 360px; /* Matches vehicle card height from create.blade.php */
            overflow-y: auto;
            padding-right: 1rem;
        }
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-sm rounded-lg p-4 flex justify-between items-center mb-6">
                <h2 class="text-xl font-semibold font-heading text-gray-800">Edit Vehicle</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-section space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="make" id="make" value="<?php echo e(old('make', $vehicle->make)); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="model" id="model" value="<?php echo e(old('model', $vehicle->model)); ?>" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., Camry">
                                </div>
                                <div>
                                    <label for="year" class="block text-sm font-medium text-gray-700">Year *</label>
                                    <input type="number" name="year" id="year" value="<?php echo e(old('year', $vehicle->year)); ?>" min="1900" max="2025" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., 2022">
                                </div>
                                <div>
                                    <label for="registration_number" class="block text-sm font-medium text-gray-700">Registration Number *</label>
                                    <input type="text" name="registration_number" id="registration_number" value="<?php echo e(old('registration_number', $vehicle->registration_number)); ?>" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                            ...
                            <div class="form-section space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="type" id="type" required
                                        ...
                                        <option value="car" <?php echo e(old('type', $vehicle->type) == 'car' ? 'selected' : ''); ?>>Car</option>
                                        <option value="cab" <?php echo e(old('type', $vehicle->type) == 'cab' ? 'selected' : ''); ?>>Cab</option>
                                        <option value="van" <?php echo e(old('type', $vehicle->type) == 'van' ? 'selected' : ''); ?>>Van</option>
                                        <option value="minibus" <?php echo e(old('type', $vehicle->type) == 'minibus' ? 'selected' : ''); ?>>MiniBus</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="price_per_km" id="price_per_km" value="<?php echo e(old('price_per_km', $vehicle->price_per_km)); ?>" min="0" step="0.01" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., 50.00">
                                </div>
                                <div>
                                    <label for="passengers" class="block text-sm font-medium text-gray-700">Passengers *</label>
                                    <input type="number" name="passengers" id="passengers" value="<?php echo e(old('passengers', $vehicle->passengers)); ?>" min="1" max="50" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., 5">
                                </div>
                                <div>
                                    <label for="features" class="block text-sm font-medium text-gray-700">Features</label>
                                    <input type="text" name="features" id="features" value="<?php echo e(old('features', $vehicle->features ? implode(', ', $vehicle->features) : '')); ?>"
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                            ...
                            <div class="col-span-1 md:col-span-2 space-y-4">
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                              class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                              placeholder="e.g., Comfortable sedan for city travel"><?php echo e(old('description', $vehicle->description)); ?></textarea>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Availability</label>
                                    <div class="mt-1 flex items-center">
                                        <input id="available" name="available" type="checkbox" value="1" <?php echo e(old('available', $vehicle->available) ? 'checked' : ''); ?>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <?php if($vehicle->image): ?>
                                            <div class="mt-2">
                                                <img src="<?php echo e(asset('storage/'.$vehicle->image)); ?>" alt="Current vehicle image" class="h-48 rounded-lg object-cover">
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/admin/vehicles/edit.blade.php ENDPATH**/ ?>