        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('driver.dashboard')); ?>" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
            ...
            <main class="p-6">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl p-6 mb-6 shadow-md transition duration-300 hover:scale-105">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-blue-100">You have <?php echo e($todayAssignments); ?> assignments today</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashboard-card bg-white shadow rounded-xl p-6 transition duration-300 hover:scale-105">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><?php echo e($todayAssignments); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="dashboard-card bg-white shadow rounded-xl p-6 transition duration-300 hover:scale-105">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><?php echo e($completedTrips); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow rounded-xl p-6 mb-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="<?php echo e(route('driver.bookings.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 flex items-center">
                            View All <i class="fas fa-chevron-right ml-1 text-xs"></i>
                        </a>
                    </div>
                    
                    <?php if($upcomingAssignments->isEmpty()): ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $upcomingAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e($booking->user->profile_photo ? asset('storage/'.$booking->user->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($booking->user->name) . '&background=random'); ?>" alt="<?php echo e($booking->user->name); ?>">
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo e($booking->vehicle->make); ?> <?php echo e($booking->vehicle->model); ?></div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500"><?php echo e($booking->total_days); ?> day(s)</div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="<?php echo e(route('driver.bookings.show', $booking->id)); ?>" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                ...
                <div class="bg-white shadow rounded-xl p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mr-3">
                                    <i class="fas fa-car"></i>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-800">You completed a trip for <?php echo e($booking->user->name); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e($booking->vehicle->make); ?> <?php echo e($booking->vehicle->model); ?> - <?php echo e($booking->updated_at->diffForHumans()); ?></p>
                                </div>
                            </div>
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/driver/dashboard.blade.php ENDPATH**/ ?>