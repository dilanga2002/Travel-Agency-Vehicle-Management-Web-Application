...
<head>
    ...
    <title>SriTravel - Customer Profile</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('profile.show')); ?>" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold font-heading text-gray-800">Customer Profile</h1>
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 hidden md:inline">
                        Last login: <?php echo e(auth()->user()->last_login_at?->diffForHumans() ?? 'First time login'); ?>
            ...
            <main class="p-6 bg-white rounded-xl shadow">
                ...
                <div class="max-w-2xl mx-auto">
                    ...
                    <section class="mb-12">
                        ...
                        <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-field">
                                ...
                                <div class="flex items-center">
                                    <img class="h-16 w-16 rounded-full object-cover" src="<?php echo e(auth()->user()->profile_photo ? asset('storage/'.auth()->user()->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=random'); ?>" alt="<?php echo e(auth()->user()->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(old('name', auth()->user()->name)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="email" name="email" id="email" value="<?php echo e(old('email', auth()->user()->email)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', auth()->user()->phone)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="address" id="address" class="w-full"><?php echo e(old('address', auth()->user()->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <section class="mb-12">
                        ...
                        <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="mt-6 space-y-6">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Permanently delete your account. This action cannot be undone.</p>
                        </header>

                        <form action="<?php echo e(route('profile.destroy')); ?>" method="POST" class="mt-6 space-y-6" onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be undone.');">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="password" name="current_password" id="delete_current_password" class="w-full" autocomplete="current-password">
                                <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/profile/show.blade.php ENDPATH**/ ?>