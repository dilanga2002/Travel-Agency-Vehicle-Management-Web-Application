...
<head>
    ...
    <title>SriTravel - Admin Add New Driver</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <h2 class="text-xl font-semibold font-heading text-gray-800">Add New Driver</h2>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                              class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                              placeholder="e.g., No. 123, Colombo Road, Colombo 03"><?php echo e(old('address')); ?></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="license_number" id="license_number" value="<?php echo e(old('license_number')); ?>" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" id="password" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                           placeholder="Enter password" minlength="8" title="Password must be at least 8 characters long">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                           placeholder="Confirm password" minlength="8" title="Password confirmation must match the password">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="status" value="active" class="form-radio h-4 w-4 text-blue-600" <?php echo e(old('status', 'active') == 'active' ? 'checked' : ''); ?> required>
                                            <span class="ml-2 text-sm text-gray-600">Active</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="status" value="inactive" class="form-radio h-4 w-4 text-blue-600" <?php echo e(old('status') == 'inactive' ? 'checked' : ''); ?>>
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/admin/drivers/create.blade.php ENDPATH**/ ?>