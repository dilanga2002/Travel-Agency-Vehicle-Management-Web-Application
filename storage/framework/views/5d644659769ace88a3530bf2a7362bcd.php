...
<head>
    ...
    <title>SriTravel - Driver Profile</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="p-4 border-b border-blue-800 flex items-center">
                <img class="h-10 w-10 rounded-full mr-3" src="<?php echo e($driver->profile_photo ? asset('storage/'.$driver->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($driver->name) . '&background=random'); ?>" alt="Driver avatar">
                <div>
                    <p class="font-medium"><?php echo e($driver->name); ?></p>
                    <p class="text-blue-200 text-xs"><?php echo e($driver->email); ?></p>
                </div>
            </div>
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('driver.bookings.index')); ?>" class="text-blue-200 hover:text-white hover:bg-blue-700 flex items-center">
                            <i class="fas fa-calendar-check"></i> Bookings
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('driver.profile.edit')); ?>" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold font-heading text-gray-800">Driver Profile</h1>
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 hidden md:inline">
                        Last login: <?php echo e($driver->last_login_at ? $driver->last_login_at->diffForHumans() : 'First time login'); ?>
                ...
                <div class="max-w-2xl mx-auto">
                    ...
                    <section class="mb-12">
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Update your account's profile information, email address, and license details.</p>
                        </header>

                        <form action="<?php echo e(route('driver.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-field">
                                ...
                                <div class="flex items-center">
                                    <img class="h-16 w-16 rounded-full object-cover" src="<?php echo e($driver->profile_photo ? asset('storage/'.$driver->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($driver->name) . '&background=random'); ?>" alt="<?php echo e($driver->name); ?>">
                                    <div class="ml-4 flex-1">
                                        <div class="custom-file-input">
                                            <input type="file" name="profile_photo" id="profile_photo" accept="image/*">
                                            <label for="profile_photo">Choose File</label>
                                            <span id="profile-file-name">No file chosen</span>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(old('name', $driver->name)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="email" name="email" id="email" value="<?php echo e(old('email', $driver->email)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', $driver->phone)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="address" id="address" class="w-full"><?php echo e(old('address', $driver->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="license_number" id="license_number" value="<?php echo e(old('license_number', $driver->license_number)); ?>" class="w-full">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <section>
                        ...
                        <form action="<?php echo e(route('driver.profile.update')); ?>" method="POST" class="mt-6 space-y-6">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // File input name display for profile photo
            ...
            profileFileInput.addEventListener('change', function () {
                profileFileNameDisplay.textContent = this.files.length > 0 ? this.files[0].name : 'No file chosen';
            });
        });
    </script>
</body>
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/driver/profile/edit.blade.php ENDPATH**/ ?>