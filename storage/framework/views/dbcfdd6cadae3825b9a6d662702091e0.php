...
<body>
<div class="wrapper">
    <a href="<?php echo e(url('/')); ?>" class="home-icon"><i class="fas fa-home"></i></a>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <?php if(session('status')): ?>
            <div class="error-text mb-4">
                <i class="fas fa-exclamation-circle"></i> <?php echo e(session('status')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if(Route::has('password.request')): ?>
            <div class="text-center mt-4">
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-700 hover:underline">Forgot your password?</a>
            </div>
        <?php endif; ?>

        <div class="text-center mt-4 text-gray-600 text-sm">
            <p>Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold relative after:content-[''] after:absolute after:bottom-[-2px] after:left-0 after:w-full after:h-0.5 after:bg-blue-600 after:scale-x-0 after:origin-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-left">Sign up</a></p>
        </div>
    </form>
</div>
</body>
</html><?php /**PATH C:\Users\User\Desktop\New folder\sritt\sritt\sritravel\sritravel\resources\views/auth/login.blade.php ENDPATH**/ ?>