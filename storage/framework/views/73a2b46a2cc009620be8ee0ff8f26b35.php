...
<head>
    ...
    <title>SriTravel - Edit Booking</title>
    ...
    <style>
        ...
        .form-input {
            transition: all 0.3s;
            border: 2px solid #D1D5DB !important; /* Added visible border */
        }
        .form-input:focus {
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('vehicles.index')); ?>" class="active-menu-item flex items-center">
        ...
        <div class="main-content">
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold font-heading text-gray-800">Edit Booking #<?php echo e($booking->id); ?></h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(route('bookings.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">My Bookings</a>
                                </div>
                            </li>
                            <li aria-current="page">
                                <div class="flex items-center">
                                    <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Booking</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                </div>
                <a href="<?php echo e(route('bookings.show', $booking->id)); ?>" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-transparent rounded-md font-semibold text-xs text-gray-800 uppercase tracking-widest hover:bg-gray-200 active:bg-gray-300 focus:outline-none focus:border-gray-300 focus:ring focus:ring-gray-200 disabled:opacity-25 transition">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2">
                        <div class="bg-white shadow rounded-xl p-6">
                            <h2 class="text-lg font-medium text-gray-800 mb-6">Edit Booking Details</h2>
                            <form action="<?php echo e(route('bookings.update', $booking->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                <input type="hidden" name="user_id" value="<?php echo e(auth()->id()); ?>">
                                <input type="hidden" name="vehicle_id" value="<?php echo e($booking->vehicle_id); ?>">

                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="start_date" class="block text-sm font-medium text-gray-700 mb-1">Start Date</label>
                                        <input type="date" name="start_date" id="start_date" value="<?php echo e(old('start_date', $booking->start_date->format('Y-m-d'))); ?>" min="<?php echo e(now()->toDateString()); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['start_date'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="end_date" id="end_date" value="<?php echo e(old('end_date', $booking->end_date->format('Y-m-d'))); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="time" name="pickup_time" id="pickup_time" value="<?php echo e(old('pickup_time', $booking->pickup_time)); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['pickup_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="pickup_location" id="pickup_location" value="<?php echo e(old('pickup_location', $booking->pickup_location)); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['pickup_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="dropoff_location" id="dropoff_location" value="<?php echo e(old('dropoff_location', $booking->dropoff_location)); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['dropoff_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="destination" id="destination" value="<?php echo e(old('destination', $booking->destination)); ?>" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['destination'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        <label for="driver_id" class="block text-sm font-medium text-gray-700 mb-1">Assign Driver</label>
                                        <select name="driver_id" id="driver_id" class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['driver_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($driver->id); ?>" <?php echo e(old('driver_id', $booking->driver_id) == $driver->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="total_KiloMeter" id="total_KiloMeter" value="<?php echo e(old('total_KiloMeter', $booking->total_KiloMeter)); ?>" min="1" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 <?php $__errorArgs = ['total_KiloMeter'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__errorArgs = ['total_KiloMeter'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea name="special_requests" id="special_requests" rows="4" 
                                                  class="form-input w-full rounded-md shadow-sm px-3 py-2 <?php $__errorArgs = ['special_requests'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                  placeholder="Any special requirements or notes..."><?php echo e(old('special_requests', $booking->special_requests)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-white shadow rounded-xl p-6 sticky top-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium">Rs. <?php echo e(number_format($booking->vehicle->price_per_km, 2)); ?></span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="border-t border-gray-200 pt-4 mt-4">
                                    <div class="flex justify-between font-bold text-lg">
                                        ...
                                        <span id="summary-total">Rs. <?php echo e(number_format($booking->total_amount, 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function updateBookingSummary() {
            ...
            const pricePerKm = parseFloat("<?php echo e($booking->vehicle->price_per_km); ?>") || 0;
...
</html><?php /**PATH D:\fproject\project\project\sritravel\sritravel\resources\views/bookings/edit.blade.php ENDPATH**/ ?>