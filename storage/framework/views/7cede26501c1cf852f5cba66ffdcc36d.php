                ...
                <div class="content-area">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="flex items-center mb-6">
                            <img src="<?php echo e($user->profile_photo ? asset('storage/' . $user->profile_photo) : 'https://via.placeholder.com/80'); ?>" alt="<?php echo e($user->name); ?>" class="h-20 w-20 rounded-full mr-4">
                            <div>
                                <h3 class="text-xl font-semibold text-gray-800"><?php echo e($user->name); ?></h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900"><?php echo e($user->id); ?></p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Registered On</label>
                                <p class="mt-1 text-sm text-gray-900"><?php echo e($user->created_at->format('M d, Y H:i:s')); ?></p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Last Updated</label>
                                <p class="mt-1 text-sm text-gray-900"><?php echo e($user->updated_at->format('M d, Y H:i:s')); ?></p>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\Dell\Desktop\sritravel\sritravel\resources\views/admin/customer/show.blade.php ENDPATH**/ ?>