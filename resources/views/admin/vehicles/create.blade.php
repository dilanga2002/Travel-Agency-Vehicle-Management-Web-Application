                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-section space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="year" id="year" value="{{ old('year') }}" min="1900" max="2025" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                            ...
                            <div class="form-section space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="price_per_km" id="price_per_km" value="{{ old('price_per_km') }}" min="0" step="0.01" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., 50.00">
                                </div>
                                <div>
                                    <label for="passengers" class="block text-sm font-medium text-gray-700">Passengers *</label>
                                    <input type="number" name="passengers" id="passengers" value="{{ old('passengers') }}" min="1" max="50" required
                                           class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                           placeholder="e.g., 5">
                                </div>
                                <div>
                            ...
                            <div class="col-span-1 md:col-span-2 space-y-4">
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                              class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-600 focus:border-blue-600 sm:text-sm"
                                              placeholder="e.g., Comfortable sedan for city travel">{{ old('description') }}</textarea>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Availability</label>
                                    <div class="mt-1 flex items-center">
                                        <input id="available" name="available" type="checkbox" value="1" {{ old('available', false) ? 'checked' : '' }}
