        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.dashboard') }}" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 hidden md:inline">Last login: {{ auth()->user()->last_login_at ? auth()->user()->last_login_at->diffForHumans() : 'First time login' }}</span>
                    <div class="relative">
            ...
            <main class="p-6 bg-white rounded-xl shadow">
                ...
                <div class="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    <div class="card bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div class="card-value text-2xl font-semibold text-gray-800">{{ $vehicleCount }}</div>
                        <div class="card-footer text-xs text-gray-500">{{ $vehiclePercentageChange }}% from last month</div>
                    </div>
                    ...
                    <div class="card bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div class="card-value text-2xl font-semibold text-gray-800">{{ $bookingCount }}</div>
                        <div class="card-footer text-xs text-gray-500">{{ $bookingPercentageChange }}% from last month</div>
                    </div>
                    ...
                    <div class="card bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div class="card-value text-2xl font-semibold text-gray-800">{{ $driverCount }}</div>
                        <div class="card-footer text-xs text-gray-500">{{ $newDriversThisWeek }} new this week</div>
                    </div>
                </div>
                ...
                <div class="content-area">
                    <div class="content-header flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                        ...
                        <a href="{{ route('admin.bookings.index') }}" class="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 hover:scale-105">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-full" src="{{ $booking->user->profile_photo ? asset('storage/'.$booking->user->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($booking->user->name) . '&background=random' }}" alt="{{ $booking->user->name }}">
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ $booking->vehicle->image ? asset('storage/'.$booking->vehicle->image) : asset('images/vehicle-placeholder.jpg') }}" alt="{{ $booking->vehicle->make }} {{ $booking->vehicle->model }}">
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('admin.bookings.show', $booking->id) }}" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
