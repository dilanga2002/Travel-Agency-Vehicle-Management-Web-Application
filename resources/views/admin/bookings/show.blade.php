    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.vehicles.index') }}" class="text-blue-200 hover:text-white hover:bg-blue-700 flex items-center">
                    ...
                    <li>
                        <a href="{{ route('admin.bookings.index') }}" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
        ...
        <div class="main-content">
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold font-heading text-gray-800">Booking Bk-{{ $booking->id }}</h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.bookings.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Bookings</a>
                                </div>
                            </li>
                        ...
                        <div class="bg-white shadow rounded-xl p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                                        <div class="flex-shrink-0 h-16 w-16">
                                            <img class="h-16 w-16 rounded-full object-cover" src="{{ $booking->user->profile_photo ? asset('storage/' . $booking->user->profile_photo) : asset('images/customer-placeholder.jpg') }}" alt="{{ $booking->user->name }}">
                                        </div>
                                        <div class="ml-4">
                                            <h3 class="text-lg font-medium text-gray-900">{{ $booking->user->name }}</h3>
                                            <div class="text-sm text-gray-500">{{ $booking->user->email }}</div>
                                            <div class="text-sm text-gray-500">{{ $booking->user->phone ?? 'No phone provided' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                                        <div class="flex-shrink-0 h-20 w-20">
                                            <img class="h-20 w-20 rounded-md object-cover" src="{{ $booking->vehicle->image ? asset('storage/'.$booking->vehicle->image) : asset('images/vehicle-placeholder.jpg') }}" alt="{{ $booking->vehicle->make }} {{ $booking->vehicle->model }}">
                                        </div>
                                        <div class="ml-4">
                                            <h3 class="text-lg font-medium text-gray-900">{{ $booking->vehicle->make }} {{ $booking->vehicle->model }}</h3>
                                            <div class="text-sm text-gray-500">{{ $booking->vehicle->year }} • {{ $booking->vehicle->registration_number }}</div>
                                            <div class="mt-1">
                                        ...
                                        <div class="ml-auto text-right">
                                            <div class="text-lg font-bold text-blue-600">Rs. {{ number_format($booking->vehicle->price_per_km, 2) }}</div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <div class="font-medium">{{ $booking->end_date->format('M d, Y') }}</div>
                                            </div>
                                        </div>
                                        <div class="mt-3 pt-3 border-t border-gray-200 text-center">
                                            <div class="text-sm text-gray-500">Total Rental Days</div>
                                            <div class="font-medium">{{ $booking->total_days }} day{{ $booking->total_days > 1 ? 's' : '' }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium">{{ $booking->dropoff_location }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                                        <div class="flex-shrink-0 h-16 w-16">
                                            <img class="h-16 w-16 rounded-full object-cover" src="{{ $booking->driver && $booking->driver->driver_photo ? asset('storage/' . $booking->driver->driver_photo) : asset('images/driver-placeholder.jpg') }}" alt="{{ $booking->driver ? $booking->driver->name : 'Driver' }}">
                                        </div>
                                        <div class="ml-4">
                                            <h3 class="text-lg font-medium text-gray-900">{{ $booking->driver->name }}</h3>
                                            <div class="text-sm text-gray-500">License: {{ $booking->driver->license_number }}</div>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <div class="timeline">
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="text-sm text-gray-500">{{ $booking->updated_at->format('M d, Y h:i A') }}</div>
                                            </div>
                                            @elseif($booking->status == 'cancelled')
                                            <div class="timeline-item">
