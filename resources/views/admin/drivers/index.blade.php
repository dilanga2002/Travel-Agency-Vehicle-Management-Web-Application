        ...
        <div class="main-content">
            ...
            <main class="p-6 bg-white rounded-xl shadow">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                    ...
                    <a href="{{ route('admin.drivers.create') }}" class="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 hover:scale-105">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img class="h-10 w-10 rounded-full" src="{{ $driver->driver_photo ? asset('storage/' . $driver->driver_photo) : 'https://ui-avatars.com/api/?name=' . $driver->name . '&background=random' }}" alt="Driver photo">
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="status-badge {{ $driver->status == 'active' ? 'status-active' : 'status-inactive' }}">
