        ...
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.drivers.index') }}" class="text-white bg-blue-700 border-l-4 border-blue-400 flex items-center">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    <form action="{{ route('admin.drivers.update', $driver->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                              class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                              placeholder="e.g., No. 123, Colombo Road, Colombo 03">{{ old('address', $driver->address) }}</textarea>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    @if($driver->driver_photo)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/'.$driver->driver_photo) }}" alt="Current driver photo" class="h-20 w-20 rounded-full object-cover">
                                        </div>
                                    @endif
                                    @error('driver_photo')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="status" value="active" class="form-radio h-4 w-4 text-blue-600" {{ old('status', $driver->status) == 'active' ? 'checked' : '' }} required>
                                            <span class="ml-2 text-sm text-gray-600">Active</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="status" value="inactive" class="form-radio h-4 w-4 text-blue-600" {{ old('status', $driver->status) == 'inactive' ? 'checked' : '' }}>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('admin.drivers.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Cancel
                            </a>
