            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 hidden md:inline">
                        Last login: {{ $user->last_login_at ? $user->last_login_at->diffForHumans() : 'First time login' }}
                    </span>
                    <div class="relative">
                    ...
                    <section class="mb-12">
                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
                            ...
                            <div class="form-field">
                                ...
                                <div class="flex items-center">
                                    <img class="h-16 w-16 rounded-full object-cover" src="{{ $user->profile_photo ? asset('storage/'.$user->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random' }}" alt="{{ $user->name }}">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" class="w-full">
                                @error('name')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" class="w-full">
                                @error('email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" name="phone" id="phone" value="{{ old('phone', $user->phone) }}" class="w-full">
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="address" id="address" class="w-full">{{ old('address', $user->address) }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
