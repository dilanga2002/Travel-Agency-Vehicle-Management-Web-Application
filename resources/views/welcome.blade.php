...
<body class="bg-white text-gray-700 font-sans scroll-smooth">
    ...
    <nav class="bg-white text-gray-800 py-4 shadow-sm fixed top-0 w-full z-50">
        <div class="container mx-auto px-6 flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <a href="{{ route('vehicles.index') }}" class="text-gray-600 hover:text-blue-600 font-medium flex items-center transition duration-200">
            ...
            <div class="flex flex-col lg:flex-row items-center w-full">
                <div class="lg:w-1/2 text-white mb-10 lg:mb-0 animate-on-scroll slide-right">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('vehicles.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-full hover-scale">
                            <i class="fas fa-car mr-2"></i> Find Your Vehicle
                        </a>
                        <a href="{{ route('bookings.create') }}" class="border-2 border-white hover:bg-white hover:text-blue-600 text-white font-semibold px-6 py-3 rounded-full hover-scale">
        ...
        <div class="container mx-auto px-6">
            ...
            @else
                    ...
                    <div class="vehicle-card bg-white shadow rounded-xl overflow-hidden animate-on-scroll slide-up">
                        ...
                        <div class="p-4">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="font-bold text-lg text-gray-900">{{ $vehicle->make }} {{ $vehicle->model }}</h3>
                                    <div class="flex items-center text-gray-600 text-sm mt-1">
                                        <span class="mr-2"><i class="fas fa-users mr-1 text-gray-400"></i>{{ $vehicle->passengers }} passengers</span>
                                ...
                                <div class="text-right">
                                    <div class="text-xl font-bold text-blue-600">Rs. {{ number_format($vehicle->price_per_km, 2) }}</div>
                                    <div class="text-gray-500 text-sm">per 1km</div>
                                </div>
                            </div>
                            
                            <div class="mt-4">
                                <a href="{{ auth()->check() ? route('bookings.create', ['vehicle_id' => $vehicle->id, 'price_per_km' => $vehicle->price_per_km]) : route('login') }}" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition duration-300 hover-scale">
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('vehicles.index') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full transition duration-200 hover-scale">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-3xl mx-auto text-center text-white">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ route('vehicles.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-full transition duration-200 hover-scale inline-flex items-center justify-center">
                        <i class="fas fa-car mr-2"></i> Find Your Vehicle
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="animate-on-scroll slide-up" style="transition-delay: 0.1s">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('vehicles.index') }}" class="text-gray-300 hover:text-blue-400 transition duration-200"><i class="fas fa-chevron-right text-xs mr-2"></i> Vehicles</a></li>
    ...
    <div class="fixed bottom-6 right-6 z-50 lg:hidden">
        <a href="{{ route('bookings.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-full p-4 shadow-lg flex items-center justify-center animate-bounce">
