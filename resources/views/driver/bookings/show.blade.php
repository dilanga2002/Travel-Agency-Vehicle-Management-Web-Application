        ...
        <div class="main-content">
            <header class="bg-white shadow-md rounded-lg p-4 mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 font-heading">Assignment Bk-{{ $booking->id }}</h1>
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ route('driver.bookings.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">My Assignments</a>
                                    </div>
                                </li>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex items-center mb-3">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <img class="h-12 w-12 rounded-full" 
                                                 src="{{ $booking->user->profile_photo ? asset('storage/' . $booking->user->profile_photo) : 'https://ui-avatars.com/api/?name=' . urlencode($booking->user->name) . '&background=random' }}" 
                                                 alt="Customer photo">
                                        </div>
                                        <div class="ml-3">
                                            <h4 class="font-medium text-gray-800">{{ $booking->user->name }}</h4>
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex items-center mb-3">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <img class="h-12 w-12 rounded-md object-cover" src="{{ $booking->vehicle->image ? asset('storage/'.$booking->vehicle->image) : 'https://ui-avatars.com/api/?name=' . urlencode($booking->vehicle->make . ' ' . $booking->vehicle->model) . '&background=random' }}" alt="">
                                        </div>
                                        <div class="ml-3">
                                            <h4 class="font-medium text-gray-800">{{ $booking->vehicle->make }} {{ $booking->vehicle->model }}</h4>
                                            <p class="text-sm text-gray-500">{{ $booking->vehicle->registration_number }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
