    ...
    @endauth
            ...
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 hidden md:inline">{{ $vehicles->total() }} vehicles available</span>
                    @auth
                    <a href="{{ route('bookings.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring focus:ring-blue-200 transition">
                        <i class="fas fa-calendar-check mr-2"></i> My Bookings
                    </a>
                    @else
                    <a href="{{ route('login') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring focus:ring-blue-200 transition">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="vehicle-card bg-white shadow rounded-xl overflow-hidden">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="mt-4">
                                                <a href="{{ auth()->check() ? route('bookings.create', ['vehicle_id' => $vehicle->id, 'price_per_km' => $vehicle->price_per_km]) : route('login') }}" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition duration-300 hover:scale-105">
