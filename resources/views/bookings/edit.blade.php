...
<body class="font-sans bg-gray-50">
    <div class="dashboard-container">
        <div class="sidebar bg-blue-900 text-white">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('vehicles.index') }}" class="active-menu-item flex items-center">
        ...
        <div class="main-content">
            <header class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold font-heading text-gray-800">Edit Booking #{{ $booking->id }}</h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('bookings.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">My Bookings</a>
                                </div>
                            </li>
                            ...
                            <form action="{{ route('bookings.update', $booking->id) }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $booking->start_date->format('Y-m-d')) }}" min="{{ now()->toDateString() }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('start_date') border-red-500 @enderror" required>
                                        @error('start_date')
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $booking->end_date->format('Y-m-d')) }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('end_date') border-red-500 @enderror" required>
                                        @error('end_date')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="time" name="pickup_time" id="pickup_time" value="{{ old('pickup_time', $booking->pickup_time) }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('pickup_time') border-red-500 @enderror" required>
                                        @error('pickup_time')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="pickup_location" id="pickup_location" value="{{ old('pickup_location', $booking->pickup_location) }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('pickup_location') border-red-500 @enderror" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="dropoff_location" id="dropoff_location" value="{{ old('dropoff_location', $booking->dropoff_location) }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('dropoff_location') border-red-500 @enderror" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="destination" id="destination" value="{{ old('destination', $booking->destination) }}" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('destination') border-red-500 @enderror" required>
                                        @error('destination')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="driver_id" id="driver_id" class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('driver_id') border-red-500 @enderror">
                                            ...
                                            @foreach($drivers as $driver)
                                                <option value="{{ $driver->id }}" {{ old('driver_id', $booking->driver_id) == $driver->id ? 'selected' : '' }} data-available="true">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="total_KiloMeter" id="total_KiloMeter" value="{{ old('total_KiloMeter', $booking->total_KiloMeter) }}" min="1" 
                                               class="form-input w-full h-10 rounded-md shadow-sm px-3 @error('total_KiloMeter') border-red-500 @enderror" required>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="border-t border-gray-200 pt-4 mt-4">
                                    <div class="flex justify-between font-bold text-lg">
                                        ...
                                        <span id="summary-total">Rs. {{ number_format($booking->total_amount, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function updateBookingSummary() {
            ...
            const pricePerKm = parseFloat("{{ $booking->vehicle->price_per_km }}") || 0;
